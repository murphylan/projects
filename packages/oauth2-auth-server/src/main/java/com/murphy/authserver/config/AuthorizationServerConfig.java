package com.murphy.authserver.config;
...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder) {
        ...
        RegisteredClient nextjsClient = RegisteredClient.withId(UUID.randomUUID().toString())
            ...
            .tokenSettings(TokenSettings.builder().accessTokenTimeToLive(Duration.ofHours(1)).refreshTokenTimeToLive(Duration.ofHours(24)).build())
            .build();

        return new InMemoryRegisteredClientRepository(oidcClient, nextjsClient);
    }
