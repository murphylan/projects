...
public class WebFluxExampleController {
    ...
    public Flux<Map<String, Object>> getUsers() {
        ...
        return Flux.fromIterable(List.of(
            Map.<String, Object>of("id", 1, "name", "Alice", "email", "alice@webflux.com", "type", "webflux"),
            Map.<String, Object>of("id", 2, "name", "Bob", "email", "bob@webflux.com", "type", "webflux"),
            Map.<String, Object>of("id", 3, "name", "Charlie", "email", "charlie@webflux.com", "type", "webflux")
        ))
    ...
    public Flux<Map<String, Object>> getBatchData(@RequestParam(defaultValue = "5") int count) {
        ...
        return Flux.range(1, count)
            .flatMap(i -> Mono.fromSupplier(() -> Map.<String, Object>of(
                "id", i,
                "data", "Batch item " + i,
                "timestamp", LocalDateTime.now()
    ...
    public Mono<ResponseEntity<Map<String, Object>>> errorExample() {
        return Mono.fromSupplier(() -> {
            ...
            return ResponseEntity.ok(Map.<String, Object>of("status", "success"));
        })
        .onErrorResume(error -> {
